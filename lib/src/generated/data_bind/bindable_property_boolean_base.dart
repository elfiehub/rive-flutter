...
import 'package:rive_legacy/src/rive_core/data_bind/bindable_property.dart';
...
abstract class BindablePropertyBooleanBase extends BindableProperty {
  ...
  @override
  Set<int> get coreTypes => {BindablePropertyBooleanBase.typeKey, BindablePropertyBase.typeKey};
