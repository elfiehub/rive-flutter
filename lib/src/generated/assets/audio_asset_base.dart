...
import 'package:rive_legacy/src/rive_core/assets/export_audio.dart';
...
abstract class AudioAssetBase extends ExportAudio {
  ...
  @override
  Set<int> get coreTypes => {AudioAssetBase.typeKey, ExportAudioBase.typeKey, FileAssetBase.typeKey, AssetBase.typeKey};
}
