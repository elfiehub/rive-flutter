...
import 'package:rive_legacy/src/controllers/linear_animation_controller.dart';
...
extension ArtboardAdditions on Artboard {
  ...
  StateMachineController? stateMachineByName(String name, {core.OnStateChange? onChange}) =>
