...
import 'package:rive_legacy/src/generated/text/text_variation_modifier_base.dart';
import 'package:rive_legacy/src/rive_core/text/text.dart';
import 'package:rive_common/rive_text.dart';

export 'package:rive_legacy/src/generated/text/text_variation_modifier_base.dart';

class TextVariationModifier extends TextVariationModifierBase {
  String get tagName => FontTag.tagToName(axisTag);

  @override
  void axisTagChanged(int from, int to) => modifierGroup?.textComponent?.markShapeDirty();

  @override
  void axisValueChanged(double from, double to) => modifierGroup?.textComponent?.markShapeDirty();
