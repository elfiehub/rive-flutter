...
export 'package:rive_legacy/src/generated/world_transform_component_base.dart';

/// A Component with world transform.
abstract class WorldTransformComponent extends WorldTransformComponentBase {
  Vec2D get worldTranslation => Vec2D.fromValues(worldTransform[4], worldTransform[5]);
  ...
  void markWorldTransformDirty() => addDirt(ComponentDirt.worldTransform, recurse: true);
  ...
  Mat2D get parentWorldTransform =>
      parent is WorldTransformComponent ? (parent as WorldTransformComponent).worldTransform : Mat2D.identity;
}
