...
export 'package:rive_legacy/src/generated/constraints/constraint_base.dart';
...
abstract class Constraint extends ConstraintBase {
  ...
  TransformComponent? get constrainedComponent => parent is TransformComponent ? parent as TransformComponent : null;

  @override
  void strengthChanged(double from, double to) => constrainedComponent?.markTransformDirty();
