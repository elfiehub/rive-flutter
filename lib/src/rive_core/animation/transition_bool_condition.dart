...
import 'package:rive_legacy/src/generated/animation/transition_bool_condition_base.dart';
...
export 'package:rive_legacy/src/generated/animation/transition_bool_condition_base.dart';
...
class TransitionBoolCondition extends TransitionBoolConditionBase {
  ...
  bool evaluate(HashMap<int, dynamic> values) {
    ...
    return (value && op == TransitionConditionOp.equal) || (!value && op == TransitionConditionOp.notEqual);
  }
}
