...
import 'package:rive_legacy/src/generated/animation/keyframe_color_base.dart';
export 'package:rive_legacy/src/generated/animation/keyframe_color_base.dart';
...
void _apply(Core<CoreContext> object, int propertyKey, double mix, int value) {
  if (mix == 1) {
    ...
    var mixedColor = Color.lerp(Color(RiveCoreContext.getColor(object, propertyKey)), Color(value), mix);
    if (mixedColor != null) {
