...
import 'package:rive_legacy/src/rive_core/animation/linear_animation_instance.dart' as core;
...
class LinearAnimationInstance extends core.LinearAnimationInstance with RuntimeEventReporter, KeyedCallbackReporter {
  final _runtimeEventListeners = <OnRuntimeEvent>{};
  late CoreContext? context;

  LinearAnimationInstance(animation, {double speedMultiplier = 1.0, this.context})
